...
<html lang="en">
    <head>
        ...
        <title>Admin Notification: New Pending Deposit - {{ config('app.name') }}</title>
        <style>
            body {
                margin: 0;
                padding: 0;
                ...
                <tr>
                    <td>
                        <div class="header">
                            ...
                            <div class="badge">Pending Deposit Alert</div>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <div class="details-card">
                                <table class="details-table" role="presentation">
                                    <tr>
                                        ...
                                        <td>
                                            <span class="value">{{ $transaction->user->firstname }} ({{ $transaction->user->email }})</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-cell">
                            ...
                            <div class="button-container">
                                <a href="{{ url('/admin/transactions/' . $transaction->id) }}" class="button">View Transaction in Dashboard</a>
                            </div>
                        </div>
