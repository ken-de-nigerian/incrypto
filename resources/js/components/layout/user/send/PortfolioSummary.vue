<script setup lang="ts">
    import {
        ActivityIcon, BarChart3Icon, TrendingDownIcon,
        TrendingUpIcon, WalletIcon, Wallet
    } from 'lucide-vue-next';

    defineProps<{
        totalPortfolioValue: number;
        portfolioChange24h: number;
        topTokens: Array<{ symbol: string; logo: string; balance: number; value: number; }>;
        totalAssets: number;
...
<template>
    <div class="hidden sm:block">
        ...
        <div class="bg-card border border-border rounded-2xl p-4 mt-4"> <h3 class="text-sm font-semibold text-card-foreground mb-3 flex items-center gap-2">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm font-semibold text-primary">{{ availableAssetsCount }}</span>
                </div>
                <div class="flex items-center justify-between">
