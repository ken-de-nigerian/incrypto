            ...
            <div class="mt-8 space-y-4 p-4 bg-card border border-border rounded-xl">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="relative">
                        ...
                        <input v-model="form.search" type="text" placeholder="Search by name or email..." :disabled="false" class="w-full pl-10 pr-4 py-2 bg-background border border-border rounded-lg text-sm input-crypto transition-all disabled:opacity-50 disabled:cursor-not-allowed" />
                    </div>
