<script setup lang="ts">
    ...
    import { IdCardIcon, Files, CarIcon, LightbulbIcon, LandmarkIcon, FileTextIcon } from 'lucide-vue-next';
...
<template>
    <form @submit.prevent="submit" class="space-y-8">
        ...
        <div class="mb-4">
            ...
            <ActionButton :processing="form.processing">Submit KYC</ActionButton>
        </div>
    </form>
</template>
