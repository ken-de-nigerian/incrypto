                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1">
                                <div class="text-sm font-medium text-card-foreground">Send {{ tx.token_symbol }}</div>
                            ...
                            <div class="text-xs font-semibold text-destructive mb-1">-{{ parseFloat(tx.amount).toFixed(6) }} {{ tx.token_symbol }}</div>
