                ...
                <tr>
                    <td>
                        ...
                        <div class="content">
                            ...
                            <p class="subtitle">You have received an important message from {{ config('app.name') }}.</p>
                            ...
                            <div class="support-text">
                                <p>If you have any questions or need assistance, please contact our support team at <a href="mailto:{{ config('settings.site.site_email') }}" class="support-email">{{ config('settings.site.site_email') }}</a>.</p>
                            </div>
                        </div>
