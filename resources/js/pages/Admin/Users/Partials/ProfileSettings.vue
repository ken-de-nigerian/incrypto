<script setup lang="ts">
    ...
    const form = useForm({
        ...
        address: props.userProfile.profile?.address || '',
    ...
    const updatePhotoPreview = () => {
        const fileList = photoInput.value?.files;
    ...
    const submit = () => {
        form.post(route('admin.users.update', props.userProfile.id), {
            preserveScroll: true,
    ...
    const initials = computed(() => {
        if (props.userProfile) {
            const first = props.userProfile.first_name?.charAt(0) || '';
            const last = props.userProfile.last_name?.charAt(0) || '';
            ...
            <div class="p-6 pt-0">
                ...
                <div class="flex items-center flex-wrap gap-4">
                    <div class="rounded-xl h-20 w-20 object-cover border border-border overflow-hidden bg-secondary/20 flex items-center justify-center">
                        <img v-if="photoPreview || props.userProfile.profile?.profile_photo_path"
                             :src="photoPreview || props.userProfile.profile?.profile_photo_path"
                             :alt="`${props.userProfile.first_name} ${props.userProfile.last_name}`"
            ...
            <div class="p-6 pt-0 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="email" :value="props.userProfile.email" disabled type="email" class="input-crypto w-full disabled:cursor-not-allowed disabled:opacity-60" autocomplete="email"/>
                    </div>
