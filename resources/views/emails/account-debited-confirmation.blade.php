                    ...
                    <td>
                        ...
                        <div class="content">
                            ...
                            <div class="button-container">
                                <a href="{{ route('user.dashboard') }}" class="button">View My Account</a>
                            </div>

                            <div class="support-text">
                                <p>If you did not authorize this transaction, please contact our support team immediately at <a href="mailto:{{ config('settings.site.site_email') }}" class="support-email">{{ config('settings.site.site_email') }}</a>.</p>
                            </div>
                        </div>
