        ...
        <div class="lg:ml-64 pt-5 lg:pt-10 p-4 sm:p-6 lg:p-8 pb-24 lg:pb-8">
            ...
            <div class="mt-8 space-y-6">
                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-bold text-card-foreground mb-2">Payment Methods</h1>
                        <p class="text-muted-foreground">Configure and manage cryptocurrency payment processing methods</p>
                    </div>
                </div>
            </div>
