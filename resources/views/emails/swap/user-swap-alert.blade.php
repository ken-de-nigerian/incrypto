                    ...
                    <td>
                        <div class="header">
                            <div class="logo-container">
                                ...
                                <div class="welcome-badge">Swap Successful!</div>
                            </div>
                        </div>

                        <div class="content">
                            <h1 class="greeting">Your Crypto Swap was Successful!</h1>
                            <p class="subtitle">You have successfully swapped {{ $from_amount }} {{ $swap->from_token }} for {{ $to_amount }} {{ $swap->to_token }}.</p>
                            ...
                            <div class="cta-section">
                                <p class="cta-title">Check Your Wallet</p>
                                <a href="{{ route('user.dashboard') }}" class="button">View Wallet</a>
                            </div>
                            ...
                            <div class="info-box">
                                ...
                                <ul>
                                    <li><strong>Verify Transactions:</strong> Always check transaction details in your wallet.</li>
                                    <li><strong>Secure Your Account:</strong> Ensure 2FA is enabled for added protection.</li>
                                    <li><strong>Stay Vigilant:</strong> We’ll never ask for your password or recovery phrase via email.</li>
                                </ul>
                            </div>

                            <div class="support-text">
                                <p><strong>Need help?</strong></p>
                                <p>Our support team is available 24/7 at <a href="mailto:{{ config('settings.site.site_email') }}" class="support-email">{{ config('settings.site.site_email') }}</a>.</p>
                                <p style="margin-top: 12px; font-size: 14px; color: #64748b;">Visit our Help Center for guides and FAQs.</p>
                            </div>
                        </div>
