...
<html lang="en">
    <head>
        ...
        <title>Copy Trading Started - {{ config('app.name') }}</title>
        <style>
            body {
                margin: 0;
                padding: 0;
                ...
                <tr>
                    <td>
                        <div class="header">
                            ...
                            <div class="badge">Copy Trading Active</div>
                        </div>

                        <div class="content">
                            <h1 class="greeting">Copy Trading Started Successfully!</h1>
                            <p class="subtitle">Hi {{ $user->first_name }}, you are now copying {{ $traderName }}'s trades. All their trading activities will be automatically replicated in your account.</p>

                            <div class="highlight-box">
                                <h3>Copy Amount Per Trade</h3>
                                <div class="amount">${{ $amount }}</div>
                                <p>Following: {{ $traderName }}</p>
                            </div>

                            <div class="trader-details-box">
                                <div class="detail-row">
                                    <span class="detail-label">Master Trader:</span>
                                    <span class="detail-value">{{ $traderName }}</span>
                                </div>
                            ...
                            <div class="cta-section">
                                <a href="{{ route('user.trade.network.copied') }}" class="button">View Copy Trading Dashboard</a>
                            </div>
                            ...
                            <div class="info-box">
                                ...
                                <ul>
                                    <li>Every trade executed by {{ $traderName }} will be automatically copied to your account.</li>
                                    <li>Each copied trade will use ${{ $amount }} from your trading balance.</li>
                                    <li>Profits and losses will be proportional to your copy amount.</li>
                                    <li>You can monitor all copied trades in real-time from your dashboard.</li>
                                    <li>You can stop copy trading at any time without affecting your existing positions.</li>
                                    <li>Ensure your account has sufficient balance to continue copying trades.</li>
                                </ul>
                            </div>

                            <div class="support-text">
                                <p><strong>Questions about copy trading?</strong> Our support team is here to help.</p>
                        ...
                        <div class="footer">
                            ...
                            <p>You received this email because you started copy trading on our platform.</p>
